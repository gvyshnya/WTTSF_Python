...
# outliers removal
print('Removing outliers in Visits in train data...')
visits_series = train_flattened.Visits
# Truncate values to the 1th and 99th percentiles via winsorize transformation
transformed_data = pd.Series(st.mstats.winsorize(visits_series, limits=[0.01, 0.01]))
train_flattened['Visits'] = transformed_data
